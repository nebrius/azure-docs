...
The Azure module reads the environment variable AZURE\_SERVICEBUS\_CONNECTION\_STRING to obtain information required to connect to Service Bus. If this environment variables are not set, you must specify the account information when calling **createServiceBusService**.
